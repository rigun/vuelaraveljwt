            ...
            <aside class="menu">
                ...
                <div class="side-body">
                    ...
                    <ul class="menu-list">
                        ...
                        <li><router-link v-bind:to="{path: '/dashboard/admin'}"><i class="fa fa-user m-r-10" aria-hidden="true"></i>  <span>Manage Admin</span> </router-link></li>
                    ...
                    <ul id="listAkademik" class="menu-list dropdown-hiddenSide">
