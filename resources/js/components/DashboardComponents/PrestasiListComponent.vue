...
<div class="flex-container">
      <div class="columns m-t-10">
        ...
        <div class="column">
          <router-link v-bind:to="{ name: 'PrestasiPost', params: { detail: 'create', id:'new' }}" class="button is-primary is-pulled-right"><i class="fa fa-user-plus m-r-10"></i> Tambahkan Prestasi</router-link>
        </div>
      </div>
      <div class="columns m-t-10">
        <div class="column">
          ...
          <table class="table is-hoverable is-striped">
            ...
            <tbody>
                ...
                <tr v-for="(karya, index) in filterCreation" :key="karya.id">
                  ...
                  <td>
                      <router-link v-bind:to="{name: 'PrestasiPost', params: {detail: 'update', id:karya.id}}"  class="button is-primary m-r-5"  >Detail</router-link>
